...
public class WordRepetitionProgressDaoImplTest {
    ...
    public void createNewOrUpdate_ordinaryCaseOfCreation() {
        // setup
        WordRepetitionProgressMapping exe = new WordRepetitionProgressMapping(1, 2, 1, "sentenceJSON", FIRST_CYCLE.name(), true);
    ...
    public void createNewOrUpdate_ordinaryCaseOfUpdate() {
        ...
        exe = new WordRepetitionProgressMapping(1, 2, 1, "sentenceJSON1", FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(2, 2, 1, "sentenceJSON1", FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(2, 2, 2, "sentenceJSON2", SECOND_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(2, 2, 3, "sentenceJSON3", FINISHED.name(), false);
        exerciseDao.createNewOrUpdate(exe);
    ...
    public void createNewOrUpdate_sentenceNull() {
        WordRepetitionProgressMapping exe = new WordRepetitionProgressMapping(1, 2, 1, null, FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
    }

    @Test(expected = RuntimeException.class)
    public void createNewOrUpdate_statusNull() {
        WordRepetitionProgressMapping exe = new WordRepetitionProgressMapping(1, 2, 1, "sentenceJSON", null, true);
        exerciseDao.createNewOrUpdate(exe);
    }
    ...
    public void cleanByWordSetId_nothingToDeleteNotEmptyDB() {
        WordRepetitionProgressMapping exe;
        exe = new WordRepetitionProgressMapping(1, 1, 1, "sentenceJSON1", FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(2, 2, 1, "sentenceJSON1", FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(4, 4, 2, "sentenceJSON2", SECOND_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(5, 5, 3, "sentenceJSON3", FINISHED.name(), false);
        exerciseDao.createNewOrUpdate(exe);
    ...
    public void cleanByWordSetId_ordinaryCase() {
        ...
        exe = new WordRepetitionProgressMapping(1, 2, 1, "sentenceJSON1", FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(2, 3, 1, "sentenceJSON1", FIRST_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(4, 4, 2, "sentenceJSON2", SECOND_CYCLE.name(), true);
        exerciseDao.createNewOrUpdate(exe);
        exe = new WordRepetitionProgressMapping(5, 3, 3, "sentenceJSON3", FINISHED.name(), false);
        exerciseDao.createNewOrUpdate(exe);
    ...
    public void createAll_createOne() {
        // setup
        List<WordRepetitionProgressMapping> words = asList(new WordRepetitionProgressMapping(2, 5, 1, "sentenceJSON", FINISHED.name(), true));
    ...
    public void createAll_createTwo() {
        List<WordRepetitionProgressMapping> words = asList(
                new WordRepetitionProgressMapping(1, 2, 1, "sentenceJSON1", FIRST_CYCLE.name(), true),
                new WordRepetitionProgressMapping(2, 2, 3, "sentenceJSON3", FINISHED.name(), false)
        );
        exerciseDao.createAll(words);
    ...
    public void findByStatusAndByWordSetId_ordinaryCase() {
        insertExercise(1, 5, 1, "sentenceJSON1", FINISHED.name(), "1");
        insertExercise(25, 2, 2, "sentenceJSON3", SECOND_CYCLE.name(), "0");
        insertExercise(232, 3, 4, "sentenceJSON2", FIRST_CYCLE.name(), "1");
        insertExercise(22, 2, 4, "sentenceJSON2", FINISHED.name(), "1");
        insertExercise(3, 2, 5, "sentenceJSON22", FINISHED.name(), "0");
    ...
    public void findByCurrentAndByWordSetId_ordinaryCase() {
        ...
        insertExercise(232, 3, 4, "sentenceJSON2", FIRST_CYCLE.name(), "1");
        insertExercise(22, 2, 4, "sentenceJSON2", FINISHED.name(), "1");
        insertExercise(3, 2, 5, "sentenceJSON22", FINISHED.name(), "1");
    ...
    public void findByCurrentAndByWordSetId_ordinaryCaseButNothingReturn() {
        ...
        insertExercise(25, 2, 2, "sentenceJSON3", SECOND_CYCLE.name(), "0");
        insertExercise(232, 3, 4, "sentenceJSON2", FIRST_CYCLE.name(), "1");
        insertExercise(22, 2, 4, "sentenceJSON2", FINISHED.name(), "0");
        insertExercise(3, 2, 5, "sentenceJSON22", FINISHED.name(), "0");
    ...
    public void findByWordAndWordSetId_ordinaryCase() {
        ...
        insertExercise(232, 3, 4, "sentenceJSON2", FIRST_CYCLE.name(), "1");
        insertExercise(22, 2, 4, "sentenceJSON2", FINISHED.name(), "1");
        insertExercise(3, 2, 4, "sentenceJSON22", FINISHED.name(), "1");
    ...
    public void findFinishedWordSetsSortByUpdatedDate_notEmptyDBButOnlyNewExercise() {
        ...
        insertExercise(1, 5, 1, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -119);
        insertExercise(2, 5, 2, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
    ...
    public void findFinishedWordSetsSortByUpdatedDate_notEmptyDBButOnlyOneOldExercise() {
        ...
        Calendar instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -30);
        insertExercise(1, 1, 1, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -119);
        insertExercise(2, 2, 2, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -121);
        Date expectedDate = instance.getTime();
        insertExercise(3, 3, 3, "sentenceJSON3", FINISHED.name(), "0", instance.getTime());
    ...
    public void findFinishedWordSetsSortByUpdatedDate_notEmptyDBButOnlyOneOldExerciseButNotFINISHED() {
        ...
        instance.add(MINUTE, -121);
        Date expectedDate = instance.getTime();
        insertExercise(3, 3, 3, "sentenceJSON3", FIRST_CYCLE.name(), "0", instance.getTime());
    ...
    public void findFinishedWordSetsSortByUpdatedDate_notEmptyDBButOnlyTreeOldExercise() {
        ...
        insertExercise(5, 3, 3, "sentenceJSON3", FINISHED.name(), "0", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -131);
        insertExercise(4, 3, 3, "sentenceJSON3", FINISHED.name(), "0", instance.getTime());
    ...
    public void findFinishedWordSetsSortByUpdatedDate() {
        Calendar instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(HOUR, -1);
        insertExercise(1, 5, 0, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(HOUR, -3);
        insertExercise(2, 5, 1, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -130);
        insertExercise(3, 5, 2, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
        instance = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        instance.add(MINUTE, -140);
        insertExercise(4, 5, 3, "sentenceJSON1", FINISHED.name(), "1", instance.getTime());
    ...
    private void insertExercise(int id, int wordSetId, int wordIndex, String sentence, String status, String current) {
        insertExercise(id, wordSetId, wordIndex, sentence, status, current, new Date(), 0, 0);
    }

    private void insertExercise(int id, int wordSetId, int wordIndex, String sentence, String status, String current, Date updatedDate) {
        insertExercise(id, wordSetId, wordIndex, sentence, status, current, updatedDate, 0, 0);
    }

    private void insertExercise(int id, int wordSetId, int wordIndex, String sentence, String status, String current, Date updatedDate, int repCount, int forgettingCounter) {
        String sql = format("INSERT INTO %s (%s,%s,%s,%s,%s,%s,%s,%s,%s) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s');", WORD_REPETITION_PROGRESS_TABLE,
                ID_FN, WORD_SET_ID_FN, WORD_INDEX_FN, SENTENCE_IDS_FN, STATUS_FN, CURRENT_FN, UPDATED_DATE_FN, REPETITION_COUNTER_FN, "forgettingCounter",
                id, wordSetId, wordIndex, sentence, status, current, updatedDate.getTime(), repCount, forgettingCounter);
