...
public class PracticeWordSetVocabularyFragmentTest {
    ...
    public void setUp() throws JsonProcessingException, SQLException {
        ...
        WordSetServiceImpl wordSetService = new WordSetServiceImpl(daoHelper.getWordSetDao(), daoHelper.getCurrentWordSetDao(), daoHelper.getNewWordSetDraftDao(), daoHelper.getSentenceDao(), new WordSetExperienceUtilsImpl(), new WordSetMapper(mapper), mapper);
