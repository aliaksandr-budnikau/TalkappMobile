...
public class PracticeWordSetVocabularyFragmentTest {
    ...
    public void setUp() throws JsonProcessingException, SQLException {
        ...
        WordSetServiceImpl wordSetService = new WordSetServiceImpl(daoHelper.getWordSetDao(), daoHelper.getCurrentWordSetDao(), daoHelper.getNewWordSetDraftDao(), new WordSetExperienceUtilsImpl(), mapper);
