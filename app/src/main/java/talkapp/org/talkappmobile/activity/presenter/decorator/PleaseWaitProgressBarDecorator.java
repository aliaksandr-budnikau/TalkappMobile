...
public class PleaseWaitProgressBarDecorator extends PracticeWordSetPresenterDecorator {
    ...
    @Override
    public void checkRightAnswerCommandRecognized(final WordSet wordSet) {
        new SuperClassWrapper(view) {
            @Override
            void doSuperMethod() {
                PleaseWaitProgressBarDecorator.super.checkRightAnswerCommandRecognized(wordSet);
            }
        }.execute();
    }

    @Override
    public void checkAnswerButtonClick(final String answer, final WordSet wordSet) {
        new SuperClassWrapper(view) {
            @Override
            void doSuperMethod() {
                PleaseWaitProgressBarDecorator.super.checkAnswerButtonClick(answer, wordSet);
            }
        }.execute();
    }
